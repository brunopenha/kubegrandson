...
Future<void> main(List<String> args) async {
  ...
  // /home/bruno/.kube/config
  //envVars['KUBECONFIG']
  //Platform.environment

  await kubernetes.initDefault();

  // Kubeconfig config = kubernetes.toString();
  //print('kubernetes.toExternalReference: ${kubernetes.toExternalReference}');
  // print('Context: ${config.currentContext}');
